        ...
        <div className="flex items-center justify-between h-16">
          <NavLink to="/" className="flex items-center gap-3">
            <div className="p-1 rounded"> 
              <NotebookIcon width={36} height={36} />
            </div>
          ...
          <nav className="hidden md:flex items-center gap-6">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive ? "text-teal-600 font-medium" : "text-gray-700"
              }
            >
              Home
            </NavLink>
            ...
            <NavLink
              to="/notes/new"
              className="ml-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-500 text-white hover:bg-teal-600
"
            >
              + Create
            </NavLink>
